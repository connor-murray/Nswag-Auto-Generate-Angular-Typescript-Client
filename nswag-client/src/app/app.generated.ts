...
export interface IValuesClient {
    getMtDto(): Observable<MyDto | null>;
...
export class ValuesClient implements IValuesClient {
    ...
    getMtDto(): Observable<MyDto | null> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMtDto(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMtDto(<any>response_);
                } catch (e) {
                    return <Observable<MyDto | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<MyDto | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetMtDto(response: HttpResponseBase): Observable<MyDto | null> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? MyDto.fromJS(resultData200) : <any>null;
        ...
        return _observableOf<MyDto | null>(<any>null);
    }
...
export class MyDto implements IMyDto {
    name?: string | undefined;

    constructor(data?: IMyDto) {
        if (data) {
    ...
    static fromJS(data: any): MyDto {
        data = typeof data === 'object' ? data : {};
        let result = new MyDto();
        result.init(data);
        return result;
    }
